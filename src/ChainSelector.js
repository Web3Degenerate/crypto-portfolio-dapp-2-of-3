...
// At (20:53) Add in our netWorth component: https://youtu.be/TXsBAIcT6jA?si=icIlzkfMzk7D3DND&t=1253
  //Then add netWorth as a prop to ChainSelector in App.js (24:55)
// const ChainSelector = ({selectedChains, onSelectionChange}) => {
  const ChainSelector = ({selectedChains, onSelectionChange, netWorth}) => {

        // Imported from src/AssetTable.js and NetWorth.js at (25:26):
